...
public class User_dbo {
    public static final String fieldnames[] = {"id","user_id","name","screename","lang","location","geoenabled","timezone","profileurl",
                            ...
                            ,"since_id","totaltweets","udetails_processed","fri_fol_processed","utimeline_processed"};
     public static final int types[] = {5,5,2,2,2,2,3,2,2,3,3,2,3,3,1,1,3,1,1,3,1,1,5,5,5,3,3,3};
